...
class SquareTestCase(unittest.TestCase):
    ...
    def test_setting_side(self):
        ...
        sq.side = 9
        self.assertAlmostEqual(sq.side, 9)
        self.assertAlmostEqual(sq.area, 81)
        self.assertAlmostEqual(sq.diagonal, 162**0.5)

    def test_setting_area(self):
        sq = exercise.Square(100)
        sq.area = 9
        self.assertAlmostEqual(sq.side, 3)
        self.assertAlmostEqual(sq.area, 9)
        self.assertAlmostEqual(sq.diagonal, 18**0.5)
    ...
    def test_setting_diagonal(self):
        ...
        self.assertAlmostEqual(sq.diagonal, 9)
